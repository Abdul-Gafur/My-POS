...
<div class="row margin-top-5">
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><b>GH₵</b> HIGHEST EARNING</div>
            ...
            <table class="table table-striped table-responsive table-hover">
                ...
                <?php foreach($highestEarners as $get):?>
                    <tr>
                        <td><?=$get->name?></td>
                        <td>GH₵<?=number_format($get->totEarned, 2)?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><b>GH₵</b> LOWEST EARNING</div>
                ...
                <table class="table table-responsive table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$get->qty_sold?></td>
                            <td><?=$get->tot_trans?></td>
                            <td>GH₵<?=number_format($get->tot_earned, 2)?></td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
                </table>
